...
- Mutaciones administrativas: no existe un flag global oculto. Ante incidente, rotar la credencial ENV y aplicar temporalmente Access/WAF a `/admin/*` y APIs mutables.
...
- Revisar periódicamente `pnpm audit --prod`; cualquier excepción debe documentar dependencia, alcance y mitigación.
...
- [ ] Credenciales ADMIN correctas/incorrectas, logout, UI y llamadas directas probados.
